                ...
                <div className="bg-[#0a0a0c] border border-white/5 p-8 rounded-3xl shadow-2xl">
                    <form className="space-y-5">
                        ...
                        <div className="flex items-start gap-3 px-1 py-2">
                            <input type="checkbox" className="mt-1 w-4 h-4 rounded border-white/10 bg-background text-accent focus:ring-accent/20" />
                        ...
                        <button
                            type="submit"
                            className="w-full py-4 bg-accent text-background rounded-full font-bold text-xs tracking-[0.2em] uppercase hover:scale-[1.02] active:scale-[0.98] transition-all shadow-[0_10px_30px_rgba(212,255,63,0.2)] flex items-center justify-center gap-2"
                        >
